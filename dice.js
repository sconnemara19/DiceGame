...
//so you have to try and get all three dice to be 2
...
function message (){
	return prompt("Are you ready to take a chance?", "Roll");
}
...
function Level2(){
	console.log("Level 2!")
	let userinput = prompt ("Lets get ready to", "Roll");
	let dice1 = rollDie(6);  
	let dice2 = rollDie(4);
	let dice3 = rollDie(4);
	let score = 1; 
...
function Level3(){
console.log("Level 3!")
let userinput = prompt ("Let the good times", "Roll")
let dice1 = rollDie(8);
let dice2 = rollDie(4);
let dice3 = rollDie(4);
let score = 0;
...
function Level4(){
console.log("Level 4!")
userinput = prompt (" I love Rock n", "Roll")
...
function Level5(){
console.log("Level 5!")
let userinput = prompt("You thought it was done?", "Roll")
...
function Level6(){
console.log("Level 6!")
let userinput = prompt("Welcome to the final level", "Roll")
